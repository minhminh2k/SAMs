...
from .components.build_sam import sam_model_registry
from .components.predictor import SamPredictor
...
class Model(nn.Module):
    ...
    def __init__(
        ...
        mode_checkpoint: str = "checkpoints/mobilesam/mobile_sam.pt",
