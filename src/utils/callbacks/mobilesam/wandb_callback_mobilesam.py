...
from src.utils.sam.sam_utils import show_anns

from src.models.mobilesam.components.automatic_mask_generator import SamAutomaticMaskGenerator

class WandbCallback_MobileSAM(Callback):
    def __init__(
        self,
        image_path: str,
